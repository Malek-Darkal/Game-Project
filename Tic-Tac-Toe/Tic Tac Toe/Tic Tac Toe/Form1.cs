    ...
    public partial class Form1 : Form
    {
        ...
        private void checkwinner()
        {
            ...
            if (i)
            {
                ...
                if (t)
                {
                    int a = Convert.ToInt32(O_count.Text);
                    a++;
                    O_count.Text =a.ToString();
                    s = player2.Text;
                    enabledbuttons();
                }
                else
                {
                    int a = Convert.ToInt32(X_player.Text);
                    a++;
                    X_player.Text =a.ToString();
                    s = player1.Text;
                    enabledbuttons();
                }
                MessageBox.Show(s + " wins !", "WoW !");
                t_count = 0;
            }
            if (t_count == 9)
            {
                ...
                t_count = 0;
                enabledbuttons();
                int a = Convert.ToInt32(d_count.Text);
                a++;
                d_count.Text =a.ToString();
            }
        }
        ...
        {
            MessageBox.Show("By Najah & Malek","Tic Tac Toe About");
        }
